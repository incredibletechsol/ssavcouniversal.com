		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Address</h3>
									SSAVCO UNIVERSAL PVT LTD,<br>
									A/102, REMI BIZCOURT,<br>
									SHAH INDUSTRIAL ESTATE,<br>
									OFF VEERA DESAI RD,<br>
									ANDHERI WEST, <br>
									MUMBAI - 400058,<br>
									MAHARASHTRA,INDIA <br>
									Contact No :  +91 98672 20207,+91 97696 29977,+91 22 66920892,+91 22 66920893<br>
									Email Id : ssavco2020@gmail.com
								</div>  
							</div>
						</div>
	<div class="row">
